    ...
    <section class="max-w-[1100px] w-full mx-auto absolute -translate-x-1/2 left-1/2 top-[170px]">
        <div class="flex flex-col gap-[30px] items-center">
            <div class="gradient-badge w-fit p-[8px_16px] rounded-full border border-[#FED6AD] flex items-center gap-[6px]">
                ...
                <p class="font-medium text-sm text-[#FF6129]">Lets Start Your Journey With US</p>
            </div>
            <div class="flex flex-col text-white text-center">
                <h2 class="font-bold text-[40px] leading-[60px]">Invest in Yourself & Reap the Rewards</h2>
                ...
                <div class="flex flex-col rounded-3xl p-8 gap-[30px] bg-white h-fit">
                    <div class="flex flex-col gap-5">
                        <div class="flex flex-col gap-4">
                            <p class="font-semibold text-4xl leading-[54px]">An Opportunity for Everyone!</p>
                            <p class="text-[#475466] text-lg">Gain access to a variety of online courses designed to help you kickstart a new career path with confidence</p>
                        </div>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex gap-3">
                                ...
                                <p class="text-[#475466]"> Comprehensive course materials designed to support your academic growth, including videos, research guides, and notes.</p>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <p class="text-[#475466]"> Earn certifications and badges to showcase your skills and achievements on your resume or LinkedIn profile.</p>
                            </div>
                        </div>
                    </div>
                    <a href="{{route('front.checkout')}}" class="p-[20px_32px] bg-[#FF6129] text-white rounded-full text-center font-semibold text-xl transition-all duration-300 hover:shadow-[0_10px_20px_0_#FF612980]">Request for Access</a>
                </div>
            </div>
        </div>
    </section>
